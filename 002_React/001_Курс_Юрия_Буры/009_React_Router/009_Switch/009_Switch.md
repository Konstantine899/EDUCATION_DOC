...
В основном используется при обработке не существующих адресов. Смотри на Redirect и Switch
...
Если роут не существует нас будет редиректить на главную страницу.

Еще одна стратегия это не перенаправлять. А просто отрисовать компонент с ошибкой.
