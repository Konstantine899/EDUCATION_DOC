...
Если пользователь есть то у него вот это свойство есть req.session и в нем есть loggedIn тогда в теле условия можно
написать какой-то код. Иначе ошибка.
...
При нажатии на Logout разлогиневаюсь и попадаю в корневой роут.
